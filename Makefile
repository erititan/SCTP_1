...
# for Global Warning (james00@GlobalWarning1) on Thu Feb 20 12:37:34 2020
...
TTCN3_MODULES = SCTPasp_PortType.ttcn SCTPasp_Types.ttcn SCTP.ttcn
...
# this project:
GENERATED_SOURCES = SCTPasp_PortType.cc SCTPasp_Types.cc SCTP.cc
GENERATED_HEADERS = SCTPasp_PortType.hh SCTPasp_Types.hh SCTP.hh
...
GENERATED_OBJECTS = SCTPasp_PortType.o SCTPasp_Types.o SCTP.o

USER_OBJECTS = SCTPasp_PT.o

# Other files of the project (Makefile, configuration files, etc.)
# that will be added to the archived source files:
OTHER_FILES = Makefile SCTP.cfg *.log
